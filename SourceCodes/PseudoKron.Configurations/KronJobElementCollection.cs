...
{
    /// <summary>
    /// This represents the entity containing the collection of kron job element groups.
    /// </summary>
    public class KronJobElementCollection : ConfigurationElementCollection
    {
        #region Properties
        ...
        public KronJobElement this[int index]
        {
            get { return (KronJobElement)this.BaseGet(index); }
            set
            {
        ...
        public new KronJobElement this[string key]
        {
            get { return (KronJobElement)this.BaseGet(key); }
            set
            {
                var item = (KronJobElement)this.BaseGet(key);
                if (item != null)
                {
        ...
        {
            return ((KronJobElement)element).Key;
        }
        ...
        public void Add(KronJobElement element)
        {
